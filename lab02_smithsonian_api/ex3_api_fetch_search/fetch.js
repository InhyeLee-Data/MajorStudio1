...
-> "unit_code" is one of the term categories:
   culture, data_source, date, object_type, online_media_type, place, topic, unit_code
-> It looks to be part of response.rows[index].id 

2. What is the best way to include a search with topics? There are 44680 topics.
